...
// PUT api/posts/unlike/:id like a post-private
...
// POST api/posts/comment/:id comment a post-private
router.post(
  '/comment/:id',
  [auth, [check('text', 'text is required').not().isEmpty()]],
  async (req, res) => {
...
// DELETE api/posts/comment/:id/:comment_id delet a comment-private
